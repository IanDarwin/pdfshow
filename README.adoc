...
Anyway, if you don't have winget but do have "Microsoft Store", you can get winget from 
https://www.microsoft.com/p/app-installer/9nblggh4nns1#activetab=pivot:overviewtab (it's part of "Microsoft App Installer"). 
This makes for easier installation on Windows, without affecting the other environments. Just type in a terminal window:
